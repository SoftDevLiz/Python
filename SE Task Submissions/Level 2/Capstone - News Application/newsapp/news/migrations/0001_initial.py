# Generated by Django 6.0.4 on 2026-04-12 14:20
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('subscribed_journalists', models.ManyToManyField(blank=True, help_text='Individual journalists this reader follows.', limit_choices_to={'role': 'journalist'}, related_name='followers', to=settings.AUTH_USER_MODEL)),
                ('user_permissions', models.ManyToManyField(blank=True, related_name='custom_users', to='auth.permission')),
                ('publisher', models.ForeignKey(blank=True, help_text='The publisher this user works for (editors/journalists).', null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='staff', to='news.publisher')),
                ('subscribed_publishers', models.ManyToManyField(blank=True, help_text='Publishers this reader has subscribed to.', related_name='subscriber_readers', to='news.publisher')),
            ],
            options={
                'verbose_name': 'User',
